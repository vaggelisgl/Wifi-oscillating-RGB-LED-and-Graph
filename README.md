A python program creates 3 sine Waves in time which it then transmits through wifi to a seperate arduino UNO R4. The arduino oscilates all 3 colours of an RGB LED, 
